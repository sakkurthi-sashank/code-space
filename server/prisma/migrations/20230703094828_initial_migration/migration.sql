...
CREATE TABLE "CourseModule" (
    "course_module_id" TEXT NOT NULL DEFAULT gen_random_uuid(),
...
-- CreateTable
CREATE TABLE "StudentMCQQuestion" (
    "student_id" TEXT NOT NULL,
    "mcq_question_id" TEXT NOT NULL,
    "answer_choice" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "StudentMCQQuestion_pkey" PRIMARY KEY ("student_id","mcq_question_id")
);
...
CREATE TABLE "StudentCompletedCourseModule" (
    ...
    CONSTRAINT "StudentCompletedCourseModule_pkey" PRIMARY KEY ("student_id","course_module_id")
);
...
-- AddForeignKey
ALTER TABLE "Section" ADD CONSTRAINT "Section_course_module_id_fkey" FOREIGN KEY ("course_module_id") REFERENCES "CourseModule"("course_module_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "StudentMCQQuestion" ADD CONSTRAINT "StudentMCQQuestion_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "Student"("student_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StudentMCQQuestion" ADD CONSTRAINT "StudentMCQQuestion_mcq_question_id_fkey" FOREIGN KEY ("mcq_question_id") REFERENCES "MCQQuestion"("mcq_question_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "StudentCompletedCourseModule" ADD CONSTRAINT "StudentCompletedCourseModule_course_module_id_fkey" FOREIGN KEY ("course_module_id") REFERENCES "CourseModule"("course_module_id") ON DELETE RESTRICT ON UPDATE CASCADE;
